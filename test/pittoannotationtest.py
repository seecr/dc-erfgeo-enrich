...
class PitToAnnotationTest(SeecrTestCase):
    def testAnnotationFromPit(self):
        ...
        self.assertEquals('a:source', xpathFirst(placeInTime, 'dcterms:source/@rdf:resource'))
